...
// LastOnlineDateTime is a *login* stamp Palworld never updates, so flametender's
...
func TestLastSeenPrefersObservedLeaves(t *testing.T) {
	...
	// Still online: seen as recently as flametender last looked, not at their join.
...
// the heartbeat stops, and so does what flametender may claim to have watched.
