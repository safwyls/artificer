 ...
 *
 * lastSeen is flametender's own observation of the player leaving. lastOnline is
 ...
 * fallback for servers flametender has no history for, but every label below says
