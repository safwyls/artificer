  ...
  return (
    <div className="wildskeeper min-h-full font-wkbody">
          ...
          {config && (
            <>
              ...
              <WkNote>
                ...
                <code className="font-mono not-italic text-wk-rune">.wildskeeper.bak</code>. Rotating the admin password
      ...
      <Dialog open={rotated !== null} onOpenChange={(open) => !open && setRotated(null)}>
        <DialogContent className="wildskeeper border-wk-edge bg-wk-panel font-wkbody text-wk-parchment">
          <DialogHeader>
