 ...
 * action costs, not just that it is irreversible ("Anything they have not
 * sent is left on their machine", "The old holder's late check-in will be
 * kept and flagged, not lost").
 */
