...
var Definition = &game.Definition{
	...
	// The settings editor speaks enshrouded_server.json through esconfig.
	...
	// Save is nil on purpose: the core archiver's documented defaults —
	// newest non-sidecar file, -index/-info sidecars, archive everything
	// — are Enshrouded's own rules.
}
