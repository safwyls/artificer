/**
 * The Flametender signature: the server as a flame, its player slots as a
 ...
 * under prefers-reduced-motion via the .ft-flame-lit rule in index.css)
 * and gutters to an unlit wisp when it is down. Colors are the ft.*
