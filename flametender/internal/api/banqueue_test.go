...
func power(t *testing.T, app *testApp, id int64, action string, admin []*http.Cookie) {
	t.Helper()
...
func getBans(t *testing.T, app *testApp, id int64, admin []*http.Cookie) bansDTO {
	t.Helper()
...
func putBans(t *testing.T, app *testApp, id int64, admin []*http.Cookie, bans []banDTO) bansDTO {
	t.Helper()
