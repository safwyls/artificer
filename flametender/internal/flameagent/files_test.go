...
// seedConfigJSON is a minimal but valid enshrouded_server.json for the
...
func seedWorld(t *testing.T, install string) {
	...
	files := map[string]string{
		...
		filepath.Join(install, "enshrouded_server.json"): seedConfigJSON,
	}
...
func TestAgentConfigPutValidates(t *testing.T) {
	...
	onDisk, err := os.ReadFile(filepath.Join(install, "enshrouded_server.json"))
